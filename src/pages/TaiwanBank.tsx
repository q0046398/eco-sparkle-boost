...
const products = [
  ...
  },
  {
    group: 7,
    brand: "Konica Minolta",
    model: "Konica Minolta magicolor 2400W/2430x/2450/2480MF(紅色)",
    yield: 4500,
    price: 1777,
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="eco-gradient py-16 md:py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-primary-foreground mb-4">台灣銀行共同供應契約</h1>
