...
const About = () => {
  return (
    <section id="about" className="py-20 md:py-28 eco-gradient-soft">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="order-1 lg:order-2">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed mb-8">
              綠昕科技成立於台灣，專注於環保碳粉匣的製造與銷售。
              我們相信，每一個小選擇都能為地球帶來改變。透過專業的技術與嚴格的品管，
              我們提供與原廠品質相當的環保再生碳粉匣，讓您省錢的同時也為環境盡一份心力。
            </p>
